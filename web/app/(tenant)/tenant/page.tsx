...
function DashboardStat({
    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 transition-all group relative overflow-hidden">
                ...
                <div className="xl:col-span-8 space-y-8">
                    ...
                    {nextBooking ? (
                        <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm relative overflow-hidden group">
                            <div className="absolute top-0 right-0 w-64 h-64 bg-gray-50 rounded-full -mr-32 -mt-32 transition-transform group-hover:scale-105" />
                            <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                                <div className="flex-1 space-y-6">
                                    ...
                                    <div className="space-y-1">
                                        <h3 className="text-2xl font-bold text-gray-900 tracking-tight">{nextBooking.hostel.name}</h3>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-6 border-t border-gray-50">
                                        <div>
                                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest mb-1.5">Check-in Date</p>
                        ...
                        <div className="p-20 bg-white rounded-2xl border border-dashed border-gray-200 text-center flex flex-col items-center gap-6">
                            <div className="w-16 h-16 bg-gray-50 rounded-2xl flex items-center justify-center text-gray-200 border border-gray-100 shadow-inner">
                                <Building2 size={32} />
                            </div>
                            <div className="space-y-2">
                            ...
                            <Link key={i} href={hub.href} className="p-6 bg-white border border-gray-100 rounded-2xl hover:border-blue-200 hover:shadow-lg hover:shadow-blue-500/5 transition-all flex flex-col gap-4 group">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">{hub.sub}</p>
                                    </div>
                                    ...
                                    {bookings.slice(0, 4).map((booking: any) => (
                                        <div key={booking.id} className="flex gap-5 group cursor-pointer">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm font-bold text-gray-900 truncate mb-1">{booking.hostel.name}</p>
                                                <div className="flex items-center justify-between">
                                                    <span className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">#{booking.id.slice(-6).toUpperCase()}</span>
