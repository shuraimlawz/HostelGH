        ...
        return (
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <p className="text-sm font-medium text-gray-400 dark:text-gray-500 uppercase tracking-widest">Loading Strategic Asset Log...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="flex h-[80vh] items-center justify-center">
                <div className="bg-white dark:bg-gray-900 p-12 rounded-[3rem] border border-gray-100 shadow-xl text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Asset Not Found</h2>
                        <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 max-w-xs">The requested hostel record could not be retrieved from the infrastructure log.</p>
                    </div>
        ...
        <div className="max-w-[1400px] mx-auto space-y-12 pb-24 pt-8 px-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tight">{hostel.name}</h1>
                            <div className={cn(
                                "h-7 px-3 flex items-center rounded-lg text-[9px] font-bold uppercase tracking-widest border",
                                hostel.isPublished 
                                    ? "bg-emerald-50 text-emerald-600 border-emerald-100" 
                                    : "bg-gray-100 text-gray-400 dark:text-gray-500 border-gray-200"
                            )}>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <button 
                        ...
                        className={cn(
                            ...
                            hostel.isPublished 
                                ? "bg-white dark:bg-gray-900 border-2 border-orange-100 text-orange-600 hover:bg-orange-50" 
                    ...
                    <button 
                        ...
                        className={cn(
                            ...
                            hostel.isFeatured
                                ...
                                : "bg-white dark:bg-gray-900 border-2 border-gray-100 text-gray-400 dark:text-gray-500 hover:border-gray-900 hover:text-gray-900 dark:text-white"
                        )}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-12">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {hostel.images?.slice(0, 4).map((img: string, i: number) => (
                            <div key={i} className={cn(
                                "relative overflow-hidden rounded-[2.5rem] bg-gray-50 dark:bg-gray-950 border border-gray-100",
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">{hostel.rooms?.length || 0} Types Registered</span>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {hostel.rooms?.map((room: any) => (
                                <div key={room.id} className="bg-white dark:bg-gray-900 rounded-[2rem] border border-gray-100 p-6 space-y-6 hover:shadow-lg transition-all">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="font-bold text-gray-900 dark:text-white">{room.name}</h3>
                                            <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest">{room.roomConfiguration}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <div className="bg-gray-50 dark:bg-gray-950 rounded-xl p-3 space-y-1">
                                            <p className="text-[8px] font-bold text-gray-400 dark:text-gray-500 uppercase">Pax</p>
                                            <p className="text-xs font-bold text-gray-900 dark:text-white">{room.capacity}</p>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-950 rounded-xl p-3 space-y-1">
                                            <p className="text-[8px] font-bold text-gray-400 dark:text-gray-500 uppercase">Units</p>
                                            <p className="text-xs font-bold text-gray-900 dark:text-white">{room.totalUnits}</p>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-950 rounded-xl p-3 space-y-1">
                                            <p className="text-[8px] font-bold text-gray-400 dark:text-gray-500 uppercase">Stock</p>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-gray-900 rounded-[3rem] p-10 text-white space-y-8 shadow-2xl relative overflow-hidden">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-14 h-14 bg-white dark:bg-gray-900/10 rounded-2xl flex items-center justify-center text-white font-bold text-xl border border-white/10 backdrop-blur-md">
                                    {hostel.owner?.firstName?.[0]}
                                </div>
                                <div>
                                    <h3 className="text-lg font-bold tracking-tight">{hostel.owner?.firstName} {hostel.owner?.lastName}</h3>
                                    <p className="text-xs text-gray-400 dark:text-gray-500">{hostel.owner?.email}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 pt-4 border-t border-white/5">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-widest">Phone</span>
                                <span className="text-xs font-medium">{hostel.whatsappNumber || "---"}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-bold text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase tracking-widest">Onboarded</span>
                        ...
                        <Link 
                            ...
                            className="w-full h-12 bg-white dark:bg-gray-900 text-gray-900 dark:text-white rounded-xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-blue-400 hover:text-white transition-all mt-4"
                        >
                    ...
                    {/* Stats & Metadata */}
                    <div className="bg-white dark:bg-gray-900 rounded-[3rem] border border-gray-100 p-10 space-y-10">
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 bg-gray-50 dark:bg-gray-950 rounded-2xl space-y-1">
                                    <p className="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-tight">Total Bookings</p>
                                    <p className="text-xl font-bold text-gray-900 dark:text-white">{hostel._count?.bookings || 0}</p>
                                </div>
                                <div className="p-4 bg-gray-50 dark:bg-gray-950 rounded-2xl space-y-1">
                                    <p className="text-[9px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-tight">Avg Rating</p>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-gray-950 flex items-center justify-center text-gray-400 dark:text-gray-500">
                                        <Calendar size={14} />
                                    </div>
                                    <div>
                                        <p className="text-[8px] font-bold text-gray-400 dark:text-gray-500 uppercase">Created On</p>
                                        <p className="text-[11px] font-bold text-gray-900 dark:text-white">{new Date(hostel.createdAt).toLocaleString()}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-gray-950 flex items-center justify-center text-gray-400 dark:text-gray-500">
                                    ...
                                    <div>
                                        <p className="text-[8px] font-bold text-gray-400 dark:text-gray-500 uppercase">Last Registry Update</p>
                                        <p className="text-[11px] font-bold text-gray-900 dark:text-white">{new Date(hostel.updatedAt).toLocaleString()}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button 
                            className="w-full h-14 bg-gray-50 dark:bg-gray-950 text-gray-400 dark:text-gray-500 border border-dashed border-gray-200 rounded-2xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-3 cursor-not-allowed"
                        >
                            <Calendar size={18} />
                            View Audit History
                        </button>
