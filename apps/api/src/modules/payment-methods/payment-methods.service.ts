...
export class PaymentMethodsService {
    ...
    async delete(userId: string, id: string) {
        ...
        if (method.userId !== userId) throw new ForbiddenException("Not authorized to delete this payment method");
    ...
    async setDefault(userId: string, id: string) {
        ...
        if (!method) throw new NotFoundException("Payment method not found");
        if (method.userId !== userId) throw new ForbiddenException("Not authorized to modify this payment method");
