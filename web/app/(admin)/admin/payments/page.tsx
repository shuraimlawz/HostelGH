        ...
        <div className="max-w-[1600px] mx-auto space-y-12 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pt-4">
                <div>
                    ...
                    <p className="text-gray-500 font-medium text-lg">Manage incoming payments and outgoing payout requests.</p>
                </div>
            </div>

            {/* Pending Payouts Section */}
            {pendingPayouts && pendingPayouts.length > 0 && (
                <div className="bg-gray-900 text-white rounded-[3rem] p-10 space-y-8 shadow-2xl shadow-gray-200">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 bg-gray-800 rounded-2xl flex items-center justify-center text-emerald-400 shadow-xl shadow-black/20">
                                <ArrowUpRight size={28} />
                            </div>
                            <div>
                                <h2 className="text-2xl font-black italic uppercase tracking-tighter">Withdrawal Queue</h2>
                                <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest">
                                    Action Required: {pendingPayouts.length} Requests
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {pendingPayouts.map((payout: any) => (
                            <div key={payout.id} className="bg-gray-800 rounded-[2rem] p-6 border border-gray-700 relative overflow-hidden group hover:border-emerald-500/30 transition-all">
                                <div className="flex justify-between items-start mb-6">
                                    <div>
                                        <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest mb-1">Request Amount</p>
                                        <p className="text-3xl font-black tracking-tighter text-white">
                                            GH₵ {((payout.amount || 0) / 100).toLocaleString()}
                                        </p>
                                    </div>
                                    <span className="px-3 py-1 bg-orange-500/20 text-orange-400 rounded-lg text-[9px] font-black uppercase tracking-widest border border-orange-500/20">Pending</span>
                                </div>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h3 className="text-2xl font-black text-gray-950 tracking-tight">Transaction History</h3>
                </div>
                    ...
                    <div className="md:col-span-3 flex gap-4">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full bg-white border border-gray-100 rounded-[2rem] py-5 pl-16 pr-8 outline-none focus:ring-4 focus:ring-emerald-100 transition-all font-bold text-gray-950 placeholder:text-gray-400 shadow-sm"
                        ...
                        <div className="relative min-w-[180px]">
                            ...
                            <select
                                ...
                                className="w-full h-full bg-white border border-gray-100 rounded-[2rem] pl-14 pr-8 outline-none focus:ring-4 focus:ring-emerald-100 transition-all font-bold text-gray-950 shadow-sm text-sm appearance-none cursor-pointer"
                            >
                    ...
                    {paymentsLoading ? (
                        <div className="flex h-[400px] items-center justify-center">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <p className="text-sm font-black text-gray-400 uppercase tracking-widest animate-pulse">Syncing Financial Data...</p>
                            </div>
                        </div>
                    ) : (
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50/50 border-b border-gray-50">
                                        <th className="px-10 py-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Reference</th>
                                        <th className="px-10 py-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Payer Identity</th>
                                        <th className="px-10 py-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Context</th>
                                        <th className="px-10 py-8 text-[10px] font-black uppercase tracking-widest text-gray-400">Amount</th>
                                    ...
                                    {payments.map((payment: any) => (
                                        <tr key={payment.id} className="hover:bg-gray-50/50 transition-all group">
                                            <td className="px-10 py-8">
                                                <div>
                                                    <p className="font-bold text-gray-950 font-mono text-xs mb-1">{payment.reference}</p>
                                                    <p className="text-[10px] text-gray-400 font-medium flex items-center gap-1.5 uppercase tracking-wide">
                                            ...
                                            <td className="px-10 py-8">
                                                <div className="flex items-center gap-3">
                                                    <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center text-gray-500 font-bold text-xs uppercase">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-gray-400 font-medium">{payment.booking?.tenant?.email}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-10 py-8">
                                            ...
                                            <td className="px-10 py-8 text-right">
                                                <div className={cn(
                                                    "inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border text-[10px] font-black uppercase tracking-widest w-fit ml-auto",
                            ...
                            {payments.length === 0 && (
                                <div className="p-32 text-center">
                                    ...
                                    <h3 className="text-2xl font-black text-gray-950 italic uppercase tracking-tighter mb-2">No Transactions</h3>
                                    <p className="text-gray-400 font-medium">Financial records are empty for this criteria.</p>
                                </div>
                            )}
                        </div>
                    )}
    ...
    return (
        <Suspense fallback={
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    <Loader2 className="animate-spin text-emerald-600" size={40} />
                    <p className="text-sm font-black text-gray-400 uppercase tracking-widest animate-pulse">Initializing Financial Protocol...</p>
                </div>
            </div>
        }>
