        ...
        return (
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <p className="text-sm font-medium text-gray-400 uppercase tracking-widest">Retrieving Security Profile...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="flex h-[80vh] items-center justify-center">
                <div className="bg-white p-12 rounded-[3rem] border border-gray-100 shadow-xl text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-500 max-w-xs">The requested user record could not be located in the security registry.</p>
                    </div>
        ...
        <div className="max-w-[1400px] mx-auto space-y-12 pb-24 pt-8 px-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-4">
                            <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-400 border border-gray-200 overflow-hidden">
                    ...
                    {user.verificationStatus === 'PENDING' && (
                        <div className="flex gap-3">
                            <button 
                                ...
                                className="h-14 px-8 bg-white border-2 border-red-100 text-red-600 rounded-2xl font-bold text-[10px] uppercase tracking-[0.2em] hover:bg-red-50 transition-all flex items-center gap-3"
                            >
                                <XCircle size={18} />
                                Reject Verification
                            </button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="space-y-8">
                    <div className="bg-white rounded-[3rem] border border-gray-100 p-10 space-y-10 shadow-sm">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-50 rounded-3xl p-6 space-y-4 border border-gray-100">
                                        <div className="flex items-center justify-between">
                                            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">ID Number</p>
                                            <span className="text-xs font-bold text-gray-900">{user.ghanaCardId || "Not Provided"}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                    ...
                                    <div className="relative aspect-[1.6/1] bg-gray-50 rounded-[2rem] border border-gray-100 overflow-hidden group shadow-sm">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-[8px] font-bold text-gray-400 uppercase">Email Status</p>
                ...
                <div className="lg:col-span-2 space-y-12">
                    {user.role === 'OWNER' ? (
                        <div className="space-y-8">
                            <div className="flex items-center justify-between">
                                <h2 className="text-2xl font-bold text-gray-900 uppercase tracking-tight flex items-center gap-4">
                                    <Building2 className="text-blue-600" size={28} />
                                    Asset Inventory
                                </h2>
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{user.ownedHostels?.length || 0} Properties</span>
                            </div>
                            
                            <div className="grid grid-cols-1 gap-6">
                                {user.ownedHostels?.map((hostel: any) => (
                                    <div key={hostel.id} className="group bg-white rounded-[2.5rem] border border-gray-100 p-8 flex flex-col md:flex-row gap-10 items-center hover:shadow-2xl transition-all duration-700">
                                        <div className="w-full md:w-40 aspect-square rounded-2xl overflow-hidden bg-gray-50 border border-gray-100 shrink-0">
                                        ...
                                        <div className="flex-1 space-y-4">
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-400">{hostel.addressLine}, {hostel.city}</p>
                                            </div>
                                            <div className="flex flex-wrap gap-3">
                                        ...
                                        <Link 
                                            ...
                                            className="h-12 px-8 bg-gray-50 text-gray-400 rounded-xl font-bold text-[9px] uppercase tracking-widest hover:bg-gray-900 hover:text-white transition-all whitespace-nowrap"
                                        >
                                            Audit Asset
                                        </Link>
                                    </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Last 5 Activities</span>
                            </div>
                                ...
                                <table className="w-full border-collapse">
                                    <thead>
                                        <tr className="border-b border-gray-50">
                                            <th className="px-8 py-6 text-left text-[10px] font-bold text-gray-400 uppercase tracking-widest">Hostel</th>
                                            <th className="px-8 py-6 text-left text-[10px] font-bold text-gray-400 uppercase tracking-widest">Date</th>
                                            <th className="px-8 py-6 text-left text-[10px] font-bold text-gray-400 uppercase tracking-widest">Amount</th>
                                        ...
                                        {user.bookings?.map((booking: any) => (
                                            <tr key={booking.id} className="hover:bg-gray-50/50 transition-colors">
                                                <td className="px-8 py-6">
                                                    ...
                                                    <p className="text-[10px] text-gray-400 uppercase font-bold tracking-tight">Reference: {booking.id}</p>
                                                </td>
                                                <td className="px-8 py-6 text-xs text-gray-500 font-medium">
                                                    {new Date(booking.createdAt).toLocaleDateString()}
                                                </td>
                                                <td className="px-8 py-6">
                                                    <p className="font-bold text-gray-900 text-sm">₵{(booking.payment?.amount / 100).toLocaleString()}</p>
                                                </td>
                                                <td className="px-8 py-6">
                                                    <div className={cn(
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-gray-900 p-10 rounded-[3rem] text-white space-y-6 relative overflow-hidden">
                            ...
                            <div className="flex gap-4 pt-4">
                                <div className="flex-1 p-4 bg-white/5 rounded-2xl border border-white/5 text-center">
                                    <p className="text-[8px] font-bold text-gray-500 uppercase">Alerts</p>
                                    <p className="text-xl font-bold">0</p>
                                </div>
                                <div className="flex-1 p-4 bg-white/5 rounded-2xl border border-white/5 text-center">
                                    <p className="text-[8px] font-bold text-gray-500 uppercase">Reports</p>
                                    <p className="text-xl font-bold">0</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-600 p-10 rounded-[3rem] text-white space-y-6 relative overflow-hidden">
                            ...
                            <button className="w-full h-12 bg-white text-blue-600 rounded-xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-blue-50 transition-all">
