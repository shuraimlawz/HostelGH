...
export default function OnboardingPage() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950 flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
            ...
            <div className="relative z-10 w-full max-w-4xl space-y-16">
                <div className="text-center space-y-6">
                    ...
                    <div className="space-y-4">
                        <h1 className="text-4xl md:text-6xl font-bold tracking-tighter text-gray-900 dark:text-white uppercase leading-none">
                            Choose Your Role
                        </h1>
                        <p className="text-xs md:text-sm text-gray-400 dark:text-gray-500 max-w-lg mx-auto leading-relaxed font-bold uppercase tracking-widest">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            role === "TENANT"
                                ? "bg-white dark:bg-gray-950 border-blue-600 shadow-2xl dark:shadow-none shadow-blue-500/10"
                                : "bg-white dark:bg-gray-950 border-gray-100 hover:border-blue-500/20 hover:shadow-2xl dark:shadow-none shadow-sm"
                        )}
                    >
                        <div className={cn(
                            "w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-500 shadow-xl",
                            role === "TENANT" ? "bg-blue-600 text-white shadow-blue-500/20" : "bg-gray-50 dark:bg-gray-900 text-gray-400 dark:text-gray-500 group-hover:bg-blue-50 group-hover:text-blue-600"
                        )}>
                            <User size={32} />
                        </div>
                    ...
                    >
                        <div className={cn(
                            "w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-500 shadow-xl",
                            role === "OWNER" ? "bg-blue-600 text-white shadow-blue-500/20" : "bg-gray-50 dark:bg-gray-900 text-gray-400 dark:text-gray-500 group-hover:bg-blue-50 group-hover:text-blue-600"
                        )}>
                            <Building2 size={32} />
                        </div>
                        
                        <div className="space-y-3">
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight uppercase">Owner Hub</h3>
                            <p className="text-[11px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest leading-relaxed">
                        ...
                        <div className={cn(
                            "mt-auto flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest transition-all",
                            role === "OWNER" ? "text-blue-600" : "text-gray-300 group-hover:text-gray-900 dark:text-white"
                        )}>
                ...
                <div className="pt-8 flex flex-col items-center gap-10">
                    <button
                        ...
                        className={cn(
                            "w-full max-w-sm h-16 rounded-2xl font-bold text-[11px] uppercase tracking-widest transition-all duration-500 flex items-center justify-center gap-4 shadow-2xl dark:shadow-none disabled:opacity-50 disabled:cursor-not-allowed",
                            role 
                    ...
                    <div className="flex items-center gap-4 py-5 px-8 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 shadow-sm animate-pulse">
                        <ShieldCheck size={18} className="text-blue-600" /> 
                        <span className="text-[10px] font-bold text-gray-900 dark:text-white uppercase tracking-[0.2em]">Account Secured</span>
                    </div>
                </div>
            </div>
        </div>
