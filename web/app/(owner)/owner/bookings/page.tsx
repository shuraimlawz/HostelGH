    ...
    if (isLoading) return (
        <div className="flex h-[60vh] items-center justify-center">
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-sm font-medium text-gray-400">Syncing booking data...</p>
            </div>
        </div>
    );
        ...
        <div className="max-w-[1400px] mx-auto space-y-10 pb-20 pt-4 px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="space-y-2">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Reserve Network</span>
                    </div>
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 tracking-tight">Reservations</h1>
                    <p className="text-gray-500 text-sm max-w-md">Global control panel for real-time occupancy and asset distribution.</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="relative group">
                        ...
                        <input
                            ...
                            className="bg-gray-50 border border-gray-100 rounded-xl py-3 pl-12 pr-6 outline-none focus:bg-white focus:border-blue-500 transition-all font-bold text-xs shadow-sm w-full sm:w-64"
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:items-center justify-between border-b border-gray-100 pb-4">
                ...
                <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400">
                    Total Records: <span className="text-gray-900">{filteredBookings?.length || 0}</span>
                </div>
            </div>
            ...
            {filteredBookings?.length === 0 ? (
                <div className="bg-white border border-gray-100 border-dashed rounded-2xl p-20 text-center space-y-6">
                    ...
                    <div className="space-y-1">
                        <h3 className="text-lg font-bold text-gray-900">No matching reservations</h3>
                        <p className="text-sm text-gray-500 max-w-sm mx-auto">Either there are no bookings yet or no records match your current filter.</p>
                    </div>
                </div>
            ) : (
                <div className="grid grid-cols-1 gap-6">
                    {filteredBookings?.map((booking: any) => (
                        <div key={booking.id} className="group bg-white rounded-2xl border border-gray-100 p-1.5 hover:border-gray-200 hover:shadow-xl hover:shadow-blue-500/5 transition-all duration-300 overflow-hidden">
                            <div className="flex flex-col lg:flex-row">
                                ...
                                <div className="p-6 md:p-8 shrink-0 lg:w-80 border-b lg:border-b-0 lg:border-r border-gray-50">
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div className="min-w-0">
                                            <h3 className="font-bold text-lg text-gray-900 tracking-tight truncate leading-tight">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-2 text-gray-400 text-[10px] font-bold uppercase tracking-widest pl-1">
                                            <Calendar size={12} />
                                ...
                                <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8">
                                    <div className="space-y-6">
                                        <div className="space-y-1.5">
                                            ...
                                            <h4 className="font-bold text-xl text-gray-900 tracking-tight">{booking.hostel.name}</h4>
                                            <div className="flex flex-wrap gap-2 pt-1">
                                                {booking.items?.map((item: any) => (
                                                    <span key={item.id} className="text-[11px] font-bold bg-gray-50 text-gray-600 px-2.5 py-1 rounded-lg border border-gray-100">
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-6 bg-gray-50/50 p-4 rounded-xl border border-gray-100/50">
                                            <div className="space-y-0.5">
                                                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Arrival</p>
                                                <p className="font-bold text-xs text-gray-900">{new Date(booking.startDate).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}</p>
                                            </div>
                                            <ChevronRight className="text-gray-300" size={16} />
                                            <div className="space-y-0.5">
                                                <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Exit</p>
                                                <p className="font-bold text-xs text-gray-900">{new Date(booking.endDate).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' })}</p>
                                            </div>
                                        </div>
                                ...
                                {/* Operational Panel */}
                                <div className="p-6 md:p-8 lg:w-72 flex flex-col justify-center bg-gray-50/30 border-t lg:border-t-0 lg:border-l border-gray-100">
                                    <div className="space-y-3">
                                        ...
                                        {booking.status === "COMPLETED" && (
                                            <div className="p-3 bg-gray-100 rounded-xl border border-gray-200 text-center flex items-center justify-center gap-2">
                                                ...
                                                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Stay Concluded</p>
                                            </div>
                                        )}

                                        <DropdownMenu>
                                            <DropdownMenuTrigger asChild>
                                                <button className="w-full h-12 flex items-center justify-center gap-2 text-gray-400 hover:text-gray-900 font-bold text-[10px] uppercase tracking-widest rounded-xl hover:bg-white border border-transparent hover:border-gray-100 transition-all">
                                                    <MoreHorizontal size={16} /> Operations
                                                </button>
                                            </DropdownMenuTrigger>
                                            <DropdownMenuContent align="end" className="w-52 rounded-xl p-2 shadow-xl border border-gray-100 bg-white">
                                                <DropdownMenuItem className="rounded-lg p-2.5 font-bold text-xs cursor-pointer hover:bg-gray-50 flex items-center gap-3">
