...
export default function StickySearch({ isVisible }: StickySearchProps) {
    ...
    return (
        <div 
            className={cn(
                "absolute top-[70%] left-1/2 -translate-x-1/2 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] z-50",
                isVisible 
                    ? "opacity-100 -translate-y-1/2 scale-100 pointer-events-auto" 
                    : "opacity-0 -translate-y-[200%] scale-90 pointer-events-none"
            )}
        >
