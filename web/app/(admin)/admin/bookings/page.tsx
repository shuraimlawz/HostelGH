        ...
        <div className="max-w-[1600px] mx-auto space-y-12 pb-20 pt-4 px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div>
                    ...
                    <p className="text-gray-500 font-bold text-xs uppercase tracking-widest">Monitor reservation flow, status, and financial records.</p>
                </div>

                <div className="bg-white border border-gray-100 rounded-2xl flex items-center justify-center px-8 py-4 gap-4 shadow-sm">
                    <div className="w-10 h-10 bg-violet-50 rounded-xl flex items-center justify-center text-violet-600">
                        <CalendarDays size={20} />
                    </div>
                    <div>
                        <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 leading-none mb-1">Total Bookings</p>
                ...
                <div className="md:col-span-3 flex gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-gray-100 rounded-2xl py-4 pl-16 pr-8 outline-none focus:border-violet-500 transition-all font-bold text-gray-900 placeholder:text-gray-400 shadow-sm text-sm"
                    ...
                    <div className="relative min-w-[200px]">
                        ...
                        <select
                            ...
                            className="w-full h-full bg-white border border-gray-100 rounded-2xl pl-14 pr-8 outline-none focus:border-violet-500 transition-all font-bold text-gray-900 shadow-sm text-xs uppercase tracking-widest appearance-none cursor-pointer"
                        >
                ...
                {isLoading ? (
                    <div className="flex h-[400px] items-center justify-center">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest animate-pulse">Syncing Reservation Data...</p>
                        </div>
                    </div>
                ) : (
                    <div className="overflow-x-auto">
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-50 border-b border-gray-100">
                                    ...
                                    <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400">Tenant Identity</th>
                                    <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400">Hostel Asset</th>
                                    <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400">Financials</th>
                                ...
                                {bookings.map((booking: any) => (
                                    <tr key={booking.id} className="hover:bg-gray-50 transition-all group">
                                        <td className="px-8 py-6">
                                            <div>
                                                <p className="font-bold text-gray-900 font-mono text-[10px] mb-1">#{booking.id.substring(0, 12).toUpperCase()}</p>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-gray-400 font-bold uppercase tracking-tight">{booking.tenant?.email}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-xs font-bold text-gray-900 uppercase tracking-tight">{booking.hostel?.name}</span>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-2">
                        ...
                        {bookings.length === 0 && (
                            <div className="p-32 text-center">
                                ...
                                <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">No bookings match the current criteria.</p>
                            </div>
                        )}
                    </div>
                )}
                ...
                <div className="px-10 py-8 bg-gray-50/50 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <div className="flex gap-3">
                        <button
                            ...
                            disabled={page === 1}
                            className="w-12 h-12 rounded-xl border border-gray-200 bg-white flex items-center justify-center text-gray-400 hover:border-violet-500 hover:text-violet-600 transition-all shadow-sm disabled:opacity-30 disabled:hover:border-gray-200 disabled:hover:text-gray-400"
                        >
                            <ChevronLeft size={20} />
                        </button>
                        <button
    ...
    return (
        <Suspense fallback={
            <div className="flex h-[80vh] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    <Loader2 className="animate-spin text-violet-600" size={40} />
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest animate-pulse">Loading Bookings...</p>
                </div>
            </div>
        }>
