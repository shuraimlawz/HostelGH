        ...
        <div className="max-w-[1600px] mx-auto space-y-12 pb-20 pt-4 px-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 font-bold text-xs uppercase tracking-widest">Manage incoming payments and withdrawal rules.</p>
                </div>
            </div>
                ...
                <div className="bg-gray-950 text-white rounded-3xl p-10 space-y-8 shadow-xl border border-white/5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="w-14 h-14 bg-white dark:bg-gray-900/5 rounded-2xl flex items-center justify-center text-emerald-400 border border-white/10 backdrop-blur-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {pendingPayouts.map((payout: any) => (
                            <div key={payout.id} className="bg-white dark:bg-gray-900/5 rounded-2xl p-6 border border-white/10 relative overflow-hidden group hover:border-emerald-500/30 transition-all">
                                <div className="flex justify-between items-start mb-6">
                                    <div>
                                        <p className="text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest mb-1">Request Amount</p>
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="flex items-center gap-3 p-3 bg-white dark:bg-gray-900/5 rounded-xl border border-white/5">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-[10px] text-gray-400 dark:text-gray-500 truncate tracking-tight">{payout.owner?.email}</p>
                                        </div>
                                    </div>
                                    {payout.payoutMethodDetails && (
                                        <div className="p-3 bg-white dark:bg-gray-900/5 rounded-xl border border-white/5 space-y-1">
                                            <p className="text-[9px] text-gray-500 dark:text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest">Destination</p>
                                            <p className="text-xs font-bold text-gray-300">
                                                {payout.payoutMethodDetails.provider} - {payout.payoutMethodDetails.accountNumber}
                                            </p>
                                            <p className="text-[10px] text-gray-500 dark:text-gray-400 dark:text-gray-500 uppercase font-bold tracking-widest">{payout.payoutMethodDetails.accountName}</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <button
                                        ...
                                        disabled={updatePayoutMutation.isPending}
                                        className="bg-white dark:bg-gray-900/10 hover:bg-white dark:bg-gray-900/20 text-white rounded-xl py-3 font-bold text-[10px] uppercase tracking-widest transition-all active:scale-95 disabled:opacity-50"
                                    >
                                        Reject
                                    </button>
                                </div>
                    ...
                    <div className="md:col-span-3 flex gap-4">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full bg-white dark:bg-gray-900 border border-gray-100 rounded-2xl py-4 pl-16 pr-8 outline-none focus:border-blue-500 transition-all font-bold text-gray-900 dark:text-white placeholder:text-gray-400 dark:text-gray-500 shadow-sm text-sm"
                        ...
                        <div className="relative min-w-[200px]">
                            ...
                            <select
                                ...
                                className="w-full h-full bg-white dark:bg-gray-900 border border-gray-100 rounded-2xl pl-14 pr-8 outline-none focus:border-blue-500 transition-all font-bold text-gray-900 dark:text-white shadow-sm text-xs uppercase tracking-widest appearance-none cursor-pointer"
                            >
                    ...
                    {paymentsLoading ? (
                        <div className="flex h-[400px] items-center justify-center">
                            <div className="flex flex-col items-center gap-4">
                                ...
                                <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest animate-pulse">Loading transactions...</p>
                            </div>
                        </div>
                    ) : (
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50 dark:bg-gray-950 border-b border-gray-100">
                                        <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Reference</th>
                                        <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Paid By</th>
                                        <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Context</th>
                                        <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-gray-400 dark:text-gray-500">Amount</th>
                                            ...
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-gray-400 dark:text-gray-500 font-bold uppercase tracking-tight">{payment.booking?.tenant?.email}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6">
                            ...
                            {payments.length === 0 && (
                                <div className="p-32 text-center">
                                    ...
                                    <p className="text-xs text-gray-400 dark:text-gray-500 font-bold uppercase tracking-widest">No financial records found for this search.</p>
                                </div>
                            )}
                        </div>
                    )}
